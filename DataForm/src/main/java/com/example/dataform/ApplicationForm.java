...
public class ApplicationForm extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("Application Form - Elegant Purple Theme");

        // Banner
        BorderPane bannerPane = new BorderPane();
        bannerPane.setStyle("-fx-background-color: linear-gradient(to right, #4A148C, #6A1B9A); -fx-padding: 15px;");

        Text bannerText = new Text("Application Form");
        bannerText.setFont(Font.font("Arial", FontWeight.BOLD, 28));
        bannerText.setFill(Color.LAVENDER);
        ...
        formGrid.setHgap(10);
        formGrid.setVgap(10);
        formGrid.setStyle("-fx-background-color: #311B92; -fx-border-color: #7E57C2; -fx-border-radius: 10px; -fx-padding: 20px;");
        ...
        imageView.setStyle("-fx-border-color: #7E57C2;");
        ...
        mainLayout.setStyle("-fx-background-color: #512DA8;");
    ...
    private void showDataScreen() {
        ...
        dataLayout.setStyle("-fx-background-color: #311B92;");

        Label dataLabel = new Label("Submitted Data:");
        dataLabel.setStyle("-fx-font-size: 18px; -fx-font-weight: bold; -fx-text-fill: #D1C4E9;");
        ...
        for (String[] entry : submittedData) {
            ...
            entryLabel.setStyle("-fx-background-color: #7E57C2; -fx-text-fill: #FFFFFF; -fx-padding: 10px;");
    ...
    private void styleLabel(Label label) {
        label.setStyle("-fx-text-fill: #D1C4E9; -fx-font-weight: bold;");
    }

    private void styleInput(Control control) {
        control.setStyle("-fx-background-color: #5E35B1; -fx-text-fill: #D1C4E9; -fx-border-color: #7E57C2;");
    }

    private void styleButton(Button button) {
        button.setStyle("-fx-background-color: #7E57C2; -fx-text-fill: white; -fx-font-weight: bold; -fx-border-radius: 5px;");
    }

    private void styleRadioButton(RadioButton radioButton) {
        radioButton.setStyle("-fx-text-fill: #D1C4E9;");
    }
}
